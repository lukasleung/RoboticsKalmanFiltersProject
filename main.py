...
if __name__ == "__main__":
    ...
    kalman = KalmanFilter(true_initial_state=np.array([0, 2000, 0, 0]).reshape(4, 1), number_of_iters=50, acceleration=np.array([5, 5]).reshape((2, 1)), sig_acceleration=np.array([2.5, 2.5]))
    sim = Simulation(kalman.get_true_trajectory(), kalman.get_estimation())
